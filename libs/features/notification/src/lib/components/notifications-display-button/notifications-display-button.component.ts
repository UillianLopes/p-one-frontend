...
export class NotificationsDisplayButtonComponent {
  ...
  public readonly hasUnreadNotifications$ =
    this._facade.hasUnreadNotifications$;
  public readonly isUnreadNotificationsLoading$ =
    this._facade.isUnreadNotificationsLoading$;
  public readonly unreadNotificationsCount$ =
    this._facade.unreadNotificationsCount$;
